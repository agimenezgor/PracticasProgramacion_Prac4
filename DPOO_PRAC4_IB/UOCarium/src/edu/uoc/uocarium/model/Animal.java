	...
	private void setStatus(AnimalStatus status) {
		...
		if(this instanceof Danio) {
			if(getStatus() == AnimalStatus.DEAD) {
				setSpriteImage("./images/danio/danio_dead.png");
			}
			else if(getStatus() == AnimalStatus.HEALTHY) {
				setSpriteImage("./images/danio/danio_healthy.png");
			}
		}
		if(this instanceof Tetra) {
			if(getStatus() == AnimalStatus.DEAD) {
				setSpriteImage("./images/tetra/tetra_dead.png");
			}
			else if(getStatus() == AnimalStatus.HEALTHY) {
				setSpriteImage("./images/tetra/tetra_healthy.png");
			}
		}
		if(this instanceof Corydoras) {
			if(getStatus() == AnimalStatus.DEAD) {
				setSpriteImage("./images/corydoras/corydoras_dead.png");
			}
			else if(getStatus() == AnimalStatus.HEALTHY) {
				setSpriteImage("./images/corydoras/corydoras_healthy.png");
			}
		}
	}
